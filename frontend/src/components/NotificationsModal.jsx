...
export default function NotificationsModal({
  ...
  return (
    <div>
      ...
      ></div>
      <div className="pb-20 md:pb-0 z-[25] relative md:absolute w-full md:w-[340px] md:top-16 md:right-24 bg-white rounded-xl shadow-lg border-2 border-theme_medium_2 h-screen md:h-[480px]">
        ...
        <div className="p-4 overflow-y-auto h-full md:h-[400px] w-full">
          {isLoading ? (
